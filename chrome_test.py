...
class WebDriverTestCase(unittest.TestCase):
    ...
    def addressSearch(self):
            for i in range(10):
                ...
                self.driver = driver
                self.driver.get('https://www.bgmenu.com')
                ...
                streets = ['жк Гоце Делчев 15', 'жк Белите Брези 1', 'бул. Джеймс Баучър 3', 'жк Надежда 3',
                           ...
                           'ул.Беломорски Проход', 'жк Дианабад 2', '7 - ми 11 - ти километър',
    ...
    def makeAnOrder(self):
        ...
        sleep(1)
        address_field.send_keys(Keys.ENTER)
        restaurant = self.driver.find_element(
            # to do: every address to to locate first result restaurant element)
            restaurant.click()
x = WebDriverTestCase()
x.setUp()
# x.register()
